...
\subsection{Data computation and Resource management}
\label{ssec:resource_mgm}
\input{./chapters/Background/resource_mgm.tex}

\subsubsection{MapReduce}
\label{sssec:mapreduce}
\input{./chapters/Background/mapreduce.tex}

\subsubsection{YARN}
\label{sssec:yarn.tex}
...
\input{./chapters/Background/shared_state_sch.tex}

\chapter{Method}
\label{chap:method}
\input{./chapters/Method/method.tex}
